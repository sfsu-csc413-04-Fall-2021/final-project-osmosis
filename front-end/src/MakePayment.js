    ...
    return (
        <div className="payment-field">
            <div className="contents">
                ...
                <br></br>
                <input value={recipient} onChange={(a) => setRecipient(a.target.value)} className="payment-input"></input>
                ...
                <br></br>
                <input value={amount} onChange={(a) => setAmount(a.target.value)} className="payment-input"></input>
